...
public class testActivity extends BaseActivity{
	...
	StorageInfoFragment storageInfoFragment;
	StorageGoodsFragment storageGoodsFragment;
	StorageSettingFragment storageSettingFragment;
	...
	public void initData() {
		...
		storageInfoFragment = new StorageInfoFragment();
		storageSettingFragment = new StorageSettingFragment();
		storageGoodsFragment = new StorageGoodsFragment();
		
		
		fragments.add(storageInfoFragment);
		fragments.add(storageSettingFragment);
		fragments.add(storageGoodsFragment);
